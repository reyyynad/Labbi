      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6">
            <h3 className="font-bold text-blue-900 mb-3">PROFILE FEATURES:</h3>
            <ul className="text-sm text-blue-800 space-y-1">
              <li>• View professional information and activity</li>
              <li>• Manage notification preferences in Settings</li>
              <li>• Update passwords and security settings</li>
              <li>• Favorite providers for quick access</li>
            </ul>
          </div>
        </div>
      </main>
